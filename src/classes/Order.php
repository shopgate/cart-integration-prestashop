...
class ShopgateOrderPrestashop extends ShopgateModObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields'  => array(
            ...
            'is_cancellation_sent_to_shopgate' => array('type' => self::TYPE_INT),
            'reported_cancellations'           => array('type' => self::TYPE_STRING),
        ),
    );
    ...
    public function getFields()
    {
        ...
        $fields['shopgate_order']                   = pSQL($this->shopgate_order);
        ...
        $fields['is_cancellation_sent_to_shopgate'] = (int)($this->is_cancellation_sent_to_shopgate);
        $fields['reported_cancellations']           = pSQL($this->reported_cancellations);
    ...
    {
        $this->shopgate_order = base64_encode(serialize($order));
    }
    ...
    public function cancelOrder(&$message, $partial = false)
    {
        ...
        if (!$partial) {
            ...
            $cancellationInformation = empty($cancellationInformation)
                ? array()
